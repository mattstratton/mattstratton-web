...
Companion pieces: [The past keeps changing](https://www.mattstratton.com/writing/the-past-keeps-changing/) is the argument this project exists to make, about data that revises itself and why upsert makes that unfalsifiable. [Don't give the model SQL](https://www.mattstratton.com/writing/dont-give-the-model-sql/) is about the app on top of it.
