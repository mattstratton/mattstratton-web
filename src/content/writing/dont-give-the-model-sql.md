...
pubDate: 2026-08-17
topics: ['llm', 'postgres', 'tool-design', 'agents']
heroImage: /writing/dont-give-the-model-sql/dont-give-the-model-sql-cover.png
draft: false
---
...
The other two in this set: [The past keeps changing](/writing/the-past-keeps-changing/) is why the storage layer under all this is append-only, and [every number I didn't measure was wrong](/writing/every-number-i-didnt-measure-was-wrong/) is the five figures I had to retract while writing these.
