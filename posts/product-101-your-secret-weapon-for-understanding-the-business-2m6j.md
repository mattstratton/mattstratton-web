...
PMs think about user needs in terms of "[user stories](https://www.atlassian.com/agile/project-management/user-stories)" (as a [role], I want to [do something] so that [outcome]) or "[jobs to be done](https://hbr.org/2016/09/know-your-customers-jobs-to-be-done)" (when [situation], I want to [motivation], so I can [expected outcome]).
...
- **[RICE](https://www.intercom.com/blog/rice-simple-prioritization-for-product-managers/)**: Reach, Impact, Confidence, Effort
- **Value vs. Effort**: Classic 2x2 matrix
- **[Kano Model](https://www.productplan.com/glossary/kano-model/)**: Basic needs vs. performance needs vs. delighters
...
**Bad feedback:** "Developers want dark mode"<br>
...
**Bad feedback:** "This new feature is confusing"<br>
...
**[MVP (Minimum Viable Product)](https://www.agilealliance.org/glossary/mvp/)**: The smallest version of something that delivers value. Often used as an excuse to ship incomplete things, but the concept is sound.

**[Product-Market Fit](https://www.lennysnewsletter.com/p/how-to-know-if-youve-got-productmarket)**: The magical moment when you've built something that a market actually wants. Most products never achieve this.
...
**[OKRs (Objectives and Key Results)](https://www.whatmatters.com/faqs/okr-meaning-definition-example/)**: How many product teams set goals. Objectives are qualitative, key results are measurable.
...
1. **Identify the PM who owns your developer-facing products** (API, SDK, CLI, etc.)
2. **Reach out with value:** "Hey, I'm hearing a lot of feedback about [thing]. Want to chat?"
3. **Be low-maintenance:** Respect their time, be organized, come prepared
4. **Look for strategic thinkers:** Find the PMs who see the bigger picture
5. **Build the relationship over time:** This is a long game
