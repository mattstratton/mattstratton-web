...
pubDate: 2026-08-17
topics: ['postgres', 'timescaledb', 'engineering-practice', 'time-series']
heroImage: /writing/every-number-i-didnt-measure-was-wrong/every-number-i-didnt-measure-was-wrong-cover.png
draft: false
---
...
Companion pieces: [The past keeps changing](/writing/the-past-keeps-changing/) is the argument this project exists to make, about data that revises itself and why upsert makes that unfalsifiable. [Don't give the model SQL](/writing/dont-give-the-model-sql/) is about the app on top of it.
